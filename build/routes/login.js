...
exports.loginRouter.post("/api/login", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, email, senha, user, senhaDoBancoDecrypt, userId, token;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                senhaDoBancoDecrypt = encryption_1.decrypt(user[0].senha);
                if (senha !== senhaDoBancoDecrypt) {
                    res.status(400).json("Senha errada");
                    return [2 /*return*/];
                }
                userId = user[0]._id;
                token = jsonwebtoken_1.default.sign({ id: userId }, app_1.notSoSecret, {
                    expiresIn: 3000,
                });
